...
console.log(datahide);
    ...
    const getInfo = async(event) =>{
        ...
        if(cityVal === ""){
                city_name.innerText = `Plz Write City Name Before You Hit Search `;
                datahide.classList.add('data_hide');
        }else{
            try{
                let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=71a0c8d7bd12ea7183d3282ea39daaee`;
